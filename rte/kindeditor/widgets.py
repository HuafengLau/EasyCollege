...
class KindEditor(forms.Textarea):
    ...
    class Media:
        css = {
              'all': (  settings.STATIC_URL + 'kindeditor-4.1.10/themes/default/default.css',
                        settings.STATIC_URL + 'kindeditor-4.1.10/plugins/code/prettify.js',),
        }
        js  = (
                "%skindeditor-4.1.10/kindeditor.js" % settings.STATIC_URL,
                settings.STATIC_URL + 'kindeditor-4.1.10/plugins/code/prettify.js',
        )
