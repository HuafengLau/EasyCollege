...
class Eot_naming(models.Model):
    ...
    often_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'经常点名')
...
class Eot_naming_way(models.Model):
    no_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'不点名')
    sign_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'签到')
    answer_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'点名回答')
    hybrid_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'多种方式')
...
class Eot_atmosphere(models.Model):
    dead_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'死气沉沉')
    normal_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'一般')
    active_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'较活跃')
...
class Eot_teach_way(models.Model):
    PPT_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'PPT型')
    book_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'照本宣科型')
    teacher_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'自成一派型')
    hybrid_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'混合型')
...
class Eot_popularity(models.Model):
    most_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'基本上人都去')
    more_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'大部分人去')
    less_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'少部分人去')
    nobody_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'基本没人去')
...
class Eot_mid_test_way(models.Model):
    no_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'没有期中考')
    open_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'开卷考试')
    paper_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'闭卷考试')
    pravite_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'私下完成')
    inspect_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'其他考察方式')
...
class Eot_reveal(models.Model):
    draw_importence_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'划重点')
    give_paper_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'给题目')
    nothing_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'什么也不给')
    others_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'其他泄题方式')
...
class Eot_usual_work(models.Model):
    less_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'很少')
    some_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'有一些')
    more_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'很多')
...
class Eot_mid_test(models.Model):
    yes_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'有期中考')
    no_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'没有期中考')
...
class Eot(models.Model):
    ...
    naming_way = models.ForeignKey(Eot_naming_way, null=True,blank=True,verbose_name=u'点名方式')
    atmosphere = models.ForeignKey(Eot_atmosphere, null=True,blank=True,verbose_name=u'气氛')
    teach_way = models.ForeignKey(Eot_teach_way, null=True,blank=True,verbose_name=u'教学方式')
    popularity = models.ForeignKey(Eot_popularity, null=True,blank=True,verbose_name=u'人气')
    
    mid_test = models.ForeignKey(Eot_mid_test, null=True,blank=True,verbose_name=u'期中考试')
    mid_test_way = models.ForeignKey(Eot_mid_test_way,  null=True,blank=True,verbose_name=u'期中考方式')
    final_test_way = models.ForeignKey(Eot_final_test_way,  null=True,blank=True,verbose_name=u'期末考方式')
    final_test_degree = models.IntegerField(default=0, null=True,blank=True,verbose_name=u'难度总分')
...
class Eot_data(models.Model):
    ...
    price_num =  models.IntegerField(default=0,null=True,blank=True,verbose_name=u'资料定价')
    upload_time =  models.DateField(auto_now_add=True,null=True,blank=True,verbose_name=u'上传时间')
    owner = models.ForeignKey(MyUser, null=True,blank=True,verbose_name=u'资料拥有者')
...
class Eot_comment(models.Model):
    ...
    comment = models.TextField(verbose_name=u'评论内容',null=True,blank=True,)
    agree_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'评论赞')
    disagree_num = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'评论踩')
    eot = models.ForeignKey(Eot, null=True,blank=True,verbose_name=u'课程', related_name='comment_set')
...
class First_3(models.Model):
    user = models.ForeignKey(MyUser, null=True,blank=True,  verbose_name=u'评论者')
    lucky = models.IntegerField(default=0,null=True,blank=True,verbose_name=u'幸运儿') 
    eot = models.ForeignKey(Eot, null=True,blank=True, verbose_name=u'课程')
...
class Eotdata_comment(models.Model):
    user = models.ForeignKey(MyUser, null=True,blank=True,verbose_name=u'评论者')
    comment = models.TextField(verbose_name=u'评论内容',null=True,blank=True,)
    eot_data = models.ForeignKey(Eot_data, null=True,blank=True,verbose_name=u'课程资料')
    time = models.DateField(auto_now_add=True, null=True,verbose_name=u'评论时间')
...
class Eot_img(models.Model):
    ...
    owner = models.ForeignKey(MyUser, null=True,blank=True,on_delete=models.SET_NULL,
        related_name='owner_toImg', verbose_name=u'图片上传者')
