...
class LinkNewsForm3(forms.ModelForm):
    ...
    class Meta:
        model = News
        exclude = ('ups','downs','time','gold','score','controversy','hot','user','text','pic','comment_num','mp3','open','secret','read')  
...
class TextNewsForm(forms.ModelForm):
    ...
    class Meta:
        model = News
        exclude = ('ups','downs','time','gold','score','controversy','hot','user','link','pic','comment_num','mp3','open','secret','read')
...
class PicNewsForm(forms.ModelForm):
    ...
    class Meta:
        model = News
        exclude = ('ups','downs','time','gold','score','controversy','hot','user','link','text','comment_num','mp3','open','secret','pic','read')  
...
class mp3NewsForm(forms.ModelForm):
    ...
    class Meta:
        model = News
        exclude = ('ups','downs','time','gold','score','controversy','hot','user','link','text','comment_num','pic','open','secret','mp3','read') 
